...
class calIntegral:
    def __init__(self, win):
        ...
        self.integral_type_label = CTkLabel(win, bg_color = '#CBD3F9', text = "Type", font = ('Times new roman', 25), corner_radius = 10, fg_color = "#D465F0", text_color = "black", 
                                            width = 165, height = 68)
        ...
        self.level_label = CTkLabel(win, bg_color = '#CBD3F9', text = "Level", font = ('Times new roman', 25), corner_radius = 10, fg_color = "#D465F0", text_color = "black", 
                                            width = 118, height = 68)
        self.level_label.place(x=410, y = 476)
        self.radio_var2 = StringVar()
        self.radio_var2.set("cấp 1")
        options3 = ["cấp 1", "cấp 2", "cấp 3"]
        self.cap_value = CTkOptionMenu(win, bg_color = '#CBD3F9', font = ('Times new roman', 25), command = self.selection, corner_radius= 10, variable = self.radio_var2,  values = options3, 
        ...
        save_button = CTkButton(win, text = " Save ",command = self.storeResult, font = ('Times new roman', 25), fg_color = "#C6E8B1", border_color = '#12151c', border_width = 2, bg_color = '#B5EBF7', text_color = "black", corner_radius = 10, 
                                width = 165, height = 91, )
        save_button.place(x = 36, y = 245)

        help_button = CTkButton(win, text = " Help ",command = self.help, font = ('Times new roman', 25), fg_color = "#C6E8B1", border_color = '#12151c', border_width = 2, bg_color = '#B5EBF7', text_color = "black", corner_radius = 10, 
                                width = 165, height = 91, )
    ...
    def compute_integral(self):
        try:
            ...
            if self.radio_var1.get() == "indefinite":
                ...
                if (a != "-oo\n" and a != "oo\n") and (b != "oo\n" and b != "-oo\n"):
                    integral = sym.integrate(expression, (x, float(a), float(b)))
                    text = "\n  Tích phân của hàm số:\n    " + str(integral)
                else:
                    if (a == "-oo\n" and b == "-oo\n"):
                        integral = sym.integrate(expression, (x, -oo, -oo))
                        text = "\n  Tích phân của hàm số:\n    " + str(integral)
                    if ((a == "oo\n" or a == "+oo\n") and (b == "oo\n" or b == "+oo\n")):
                        integral = sym.integrate(expression, (x, oo, oo))
                        text = "\n  Tích phân của hàm số:\n    " + str(integral)
                    ...
                    if ((a == "oo\n" or a == "+oo\n") and b == "-oo\n"):
                        ...
                        text = "\n  Tích phân của hàm số:\n    " + str(integral)
                    if (a == "oo\n" or a == "+oo\n") and (b != "-oo\n" and b != "oo\n"):
                        integral = sym.integrate(expression, (x, oo, float(b)))
                        text = "\n  Tích phân của hàm số:\n    " + str(integral)
                    if a == "-oo\n" and (b != "-oo\n" and (b != "oo\n" and b != "+oo\n")):
                        integral = sym.integrate(expression, (x, -oo, float(b)))
                        text = "\n  Tích phân của hàm số:\n    " + str(integral)
                    if (b == "oo\n" or b == "+oo\n") and (a != "-oo\n" and (a != "oo\n" and a != "+oo\n")):
                        integral = sym.integrate(expression, (x, float(a), oo))
                        text = "\n  Tích phân của hàm số:\n    " + str(integral)
                    if b == "-oo\n" and (a != "-oo\n" and a != "oo\n" and a != "+oo\n"):
                        integral = sym.integrate(expression, (x, float(a), -oo))
                        text = "\n  Tích phân của hàm số:\n    " + str(integral)
