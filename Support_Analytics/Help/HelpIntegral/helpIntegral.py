...
image1 = CTkImage(light_image=Image.open("Help/HelpIntegral/buttonHelp.png"), size = (134, 87))
...
image2 = CTkImage(light_image=Image.open("Help/HelpIntegral/buttonSave.png"), size = (134, 87))
...
image3 = CTkImage(light_image=Image.open("Help/HelpIntegral/buttonUpload.png"), size = (134, 87))
...
image4 = CTkImage(light_image=Image.open("Help/HelpIntegral/writeFunction.png"), size = (477, 576))
label4 = CTkLabel(win, corner_radius = 10, fg_color = "#796fe4", text = "", image=image4, width = 477, height = 576)
label4.place(x = 539, y = 56)

image5 = CTkImage(light_image=Image.open("Help/HelpIntegral/note.png"), size = (419, 264))
